...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=YzlkNDIzNjE1M2VkOTk4ZDZmYTBjMzhkNDIwNzQ0N2RfZ3d3ZnZUY0hmZ0cyRFBLZW4yeElQdXpyQXNsdkdYaERfVG9rZW46UVFsRGJ1anF6bzAwcEN4S2V5ZGNjSU5EbkdiXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=MDI0MTlkMTU0M2NmZWQ3YzNiZjAxNDk2MDkwZWVjZjJfeGhSZFRLMk1oZVRucmRNR3BNbGk2TERKVDRzTVdXQU9fVG9rZW46QVhPeWIxM3A1b3J2ZTR4VjYwOGNGc1FubjZQXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)

![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=ZDc2NjZiZjUyZWYzZjY1NGI1NGVmMTFhNzQyNGI1YWRfYzl1NGhwUFlhVHR2WlN4WkxWZ0hnNHNmbFFVWWdPVDZfVG9rZW46S3lUTGJ6S2dsbzFJVGx4V3ExMWNiMEpZbmtlXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=MTMyM2Y3M2Q4MGE3N2Y5NGVhOTcxNjdjZWRmZWNhM2VfRWtpaGVLZmpIcFJhTnM0VDJtVGF6Z0xMV1k5WWdSVW9fVG9rZW46V0hwaGJpTG4wbzhRaUN4WEtLZGNFTjB0bjdkXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
安装 SDK，或选择一个[模板](https://feishu.feishu.cn/docx/S1pMdbckEooVlhx53ZMcGGnMnKc#share-LfVDdSGyhoXm3xxKG6BcTtWenxh)项目 GitHub 地址，Fork 此仓库并 clone 到本地，再按照 Readme.md 中说明运行项目
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=NjliMTI4ZWMyNDVhNGEyNzczMGI3ZDk0OWVjZTZjNmNfSnA3QzdzbjFtaGxYNklaWm52T0VDZG55OUdwWXRvZGRfVG9rZW46WGNuMWJFa0VIb0ZySDV4djRzMWNWNjJubmdiXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)

![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=MTZhYzE5NjBmYzhiNzEzOWIzYjljNWY0N2E0YTNlZGJfWXJ6ZHdkc3RyaTc5akthSUhxWTRMWXR1WkJ3U3UzdllfVG9rZW46SGlKeGJHaGxib1RHTkN4Sndwb2NCTTBGbktjXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
<thead>
<tr>
<th><strong>以「列出记录」接口为例：</strong></th>
<th></th>
</tr>
</thead>
<tbody>
...
<tr>
<td>域名与 OpenAPI 不同</td>
<td>https://base-api.feishu.cnhttps://base-api.larksuite.com</td>
</tr>
<tr>
<td>Path 和 Seesion</td>
<td>API 路径：/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records</td>
</tr>
<tr>
<td>Header</td>
<td>Authorization: Bearer [PersonalBaseToken]</td>
</tr>
<tr>
<td>QueryParam</td>
<td><pre><code class="language-json">filter:CurrentValue.[多行文本]="双向关联测试"
sort:"["字段1 DESC"]"
page_size:20
</code></pre></td>
</tr>
...
UI builder 将复杂的 UI 渲染简化成一行命令调用的渲染框架，以降低 UI 搭建成本。支持通过 SDK 引用，或直接 Fork [UIBuilder Template](https://replit.com/@lark-base/UIBuilder-Template)（[github地址](https://github.com/Lark-Base-Team/uibuilder-template) ），然后在 `src/runUIBuilder.tsx` 文件的 `main` 函数内调用 `UIBuilder` 的方法。详细使用方法可通过 [UIBuilder 模板使用指南](https://feishu.feishu.cn/docx/OHxZdBQrVo5uudx1moIcL5jcn3c) 了解。
...
* 如果你准备开发表单UI，或者你是非前端开发同学，想降低 UI 搭建成本，建议使用以下模板：
  ...
  1. &#x20;[UIBuilder 模板](https://replit.com/@lark-base/UIBuilder-Template)，[github地址](https://github.com/Lark-Base-Team/uibuilder-template) 入口为`src/runUIBuilder.tsx`文件，具体使用方法见[ UIBuilder 模板使用指南](https://feishu.feishu.cn/docx/OHxZdBQrVo5uudx1moIcL5jcn3c)&#x20;

* 如果你有前端开发经验则可以使用以下模板来自由搭建 UI：

  1. HTML 模板，[github地址](https://github.com/Lark-Base-Team/html-template) 入口为 `src/index.ts` 文件

  2. React 模板，[github地址](https://github.com/Lark-Base-Team/react-template) 入口为 `src/App.tsx` 文件

  3. Vue 模板，[github地址](https://github.com/Lark-Base-Team/vue-template) 入口为`src/App.vue`文件
...
1. [Nextjs 模板](https://replit.com/@lark-base/Nextjs-Template)，前端入口为 `pages/index.tsx` 文件，服务端入口为`pages/api`目录下的文件
...
完成插件开发后，你可以将其[`发布到插件中心`](https://feishu.feishu.cn/share/base/form/shrcnwTXnFVAbMPOSeaOFwIAnbf)，以供所有多维表格用户使用。插件发布到插件中心后，将由官方托管部署。在此之前你需要对插件的基本信息进行补充，我们对每个元素的价值及要求进行了说明，并提供了示例，以帮助你顺利完成发布前的准备。

发布表单：[`发布到插件中心`](https://feishu.feishu.cn/share/base/form/shrcnwTXnFVAbMPOSeaOFwIAnbf)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=MWNkZTNjNGE0YTk0NmQ4NTI1MzZmMzFmNGRkYTJhNDZfM3ZVRGd4dllDcHZNcWw0czNZUUplZVFGNHNtVjhzWTBfVG9rZW46UUJ3T2I2WW5Xb3lXMTB4U1p6dWN1NWxYbkRnXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=Nzk5ODllMDA2MjQ4YzI2NDQ2ZjBjNzY5Yjg2NTVjNWVfUFBGeFBPbUg2ajJrS3k2OU04bmFzb0Y2VzZnOVM2ZUhfVG9rZW46VTFhM2JTT0tOb0d4TlV4UjUyZGM1eVB2bndoXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=OTRlYzYyMzdjZjk4OWM2OWQyYjkzM2E3M2NlNDlhMTVfM2FtRUdRRkxXR1BvaW5YcmVjV0szWDVGcHpWV3JINXJfVG9rZW46UVE0YWI4aWhFbzdpWkV4bFRVYmM4bFdvbjBMXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)

色板

![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=NzY3ZGFiMTkxNjRjYWY4MjQ5NDdhNDE4Njc0NWEzZjdfa2hQVDhkdDRzUm5DMlM1N29UeGJtbDhPdVdDWkpCd25fVG9rZW46QzhjaWJ0TUdvb2pobVR4UjlMdGNxb1pxbmNnXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=ODM0YmZjOTBiZjBkMDYxNDIwMDJmZGIwODA1NzRmNWVfMkR5aUQ5N0c5N3NtaGc2WjRzUWM4MmJFNktVbFNyMktfVG9rZW46TWF4NWJBQzZLbzF2UFN4bWdVZmM4Ym1ibmdoXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)



在视觉上突出插件的功能和特性，而不是简单地截图。建议使用彩色背景，以确保图像在所有主题（包括深色模式）中脱颖而出。每张图片都应侧重于介绍插件的一个功能点，使用户感受到价值。

![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=OGVkM2EwZjczNzU4MWRjYjZlNGJmZjQxOWVkMjIxMzlfWXNGRE5LUG5EVjhYUUlXcjhrQnlQbWxBakhmaDM3MmpfVG9rZW46VGZmUmI2cTNTb3RCaWx4ZHU3VmNHajBlbjRjXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=MzM2NmQ3OTc2MTBkODlmMTcyOGE3MmNkZmExNTA0NDRfRVN6V1JvNnBZeXFBMXl3elBvcU01NUVqY1M3N3ZIRzFfVG9rZW46Rmd1RmI0UVJhb2NWelZ4cGhhc2NOS1l0bndlXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=ZjU4MDIxYjBiYzU4YzEwM2E0MjI4OWIwNzNjOWJkOWZfd3NkbnpnNjZXQzVTWG5FNlpUWjM2eE1MSzRBc2YxaVdfVG9rZW46U0xTVWJsQlUybzBBSVR4am8yVWNKUTNObjFkXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=YzQ5MTg0MTZiYThjNjY3YjFkMmQ2NjhiODNlZWRhYTdfcTIyYVdGV2pwTUllM2Y1U0lKejQzSHgyVENkVU04Rk5fVG9rZW46SkYxSmI5QXZjb2hnaXN4ZVRjN2NMTXJMblZmXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
出于视觉一致性考虑，对于主要由表单按钮等简单ui组成的插件，我们强烈建议开发者使用[UIBuilDer](https://feishu.feishu.cn/docx/S1pMdbckEooVlhx53ZMcGGnMnKc#share-QYxOdY9TcoAvpvx4xKncU5fon9e)来搭建，如无法满足插件功能而需要自定义样式，也应符合基础的设计规范，确保插件的视觉质量。在插件审核时，我们会确保一些基础的设计规范符合标准，如果想进一步提高插件的品质，可以参阅 [Base 开放设计规范](https://bytedance.larkoffice.com/docx/AlJhddBJAowN9cxapvccTezUn7g)。
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=MGNlMzhiZjA1NWFmOTI0ZGMyZjAyNTNiZWVjZDFhZjdfWE1YSFBOZHlOTWNISkZEY01iTzFMOWN2SUQ3ZW8yV21fVG9rZW46SDAyWGJnYnF3bzduV214d291RGNJZnlHbkxjXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=MmU5NDE4NGIwYzNiMjM5ZTNkNTdlMTNlZmY5NjkzYzFfTTBiZ09VdlIxMml4aEo3WXhDN3M0U0dZVHhpY1poWUdfVG9rZW46Qkx6NmJET0tQb2JOZjl4blE1UGNQTldxbnhoXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
我们将直接静态部署前端产物，以避免二次构建打包失败，首先需要指定构建产物目录，比如指定部署dist/index.html，
...
确保你提交的仓库中至少包含静态产物(通常为dist目录)和package.json中包含output:{静态产物目录}：

![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=ZTc5MDI0MjQ2ZTcxNjRjOWYwNWM5ODQxOGFkMTc4MDZfaDk4MWs0eFIyWnh4WmZQQkdldFBUaWtLMURWbHRudkxfVG9rZW46VmpjT2JIS1Fzb0k3RDR4ZXBiaWNwRTdFbjlkXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)

* 禁止使用history路由，请使用hash路由

* 填写[共享表单](https://feishu.feishu.cn/share/base/form/shrcnwTXnFVAbMPOSeaOFwIAnbf)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=NjAwYjM5NzliMzU0MjY1NDdjMjgyMzA3ZmU5NzdmZWNfTzM4QWVZUUR1TENIa3Bnbk1QVUxkdHVkZXdsN0dJc0xfVG9rZW46WXNpNWJRblBDb1JKaTR4YzdxRGNPeFk4bnJjXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=NWRmOTBkMjY3MDM3NTk5ZjM1NDJlNzQ4NjE0NWVjMGFfQlBqb0thTjllZVFDSGF0Qjg3Y2JHTFNvc0xqRXlHRHhfVG9rZW46Qkl4ZWJkaGpmb0w5SWF4N2I0TWN1WEFJblViXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)

## 如何获取 `view_id`

多维表格 URL 中如下图所示部分（推荐使用「[开发工具](https://feishu.feishu.cn/base/extension/replit_3c13eb5bb6ae63e6)」插件获取）

![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=MDk3Yjg5M2E1YmMyYmNiMDVlZDFkMWJhZWIxOGNlNTlfNlkwWWxnUWVWeGhCZ3BaVW53dndQbk9RdXIxUW10Z0FfVG9rZW46WFpmVmIzYWtYb0V0aDJ4bWdsSmNlVUYwblpXXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
你可以将 fork 出来的模板的 node\_modules 删掉（如果不删掉就直接下载，可能会有点慢），然后将代码下载到本地。

为了在本地运行代码，你需要安装[ nodejs ](https://nodejs.org/en)以及[ vscode](https://code.visualstudio.com/)。

![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=ODU2YTRkZDI1ZWVmMzNlZjQ1OWYyZTJhNzI1ZTUwMjBfeGlOOGJuczdDN0VhdllORkkweWtaVHNoSDZReWxXcFZfVG9rZW46TTZJbGJUMHUyb2FzaTF4enFEc2NJeVdKblBlXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=ZDRlYWI5YzAyZTI2ZTYwZjUxNzUxMDU0NjNkZjA0NDBfV0pnbjNKOUt6Unp6aGFMcXpuSWo1dkY3akFnRnRHUm1fVG9rZW46WHQwcGJ0aTBxb2x6cGl4OE9HR2N4em1tbmlmXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)

![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=MDM4YTBlNTM3YWE3MjQ2ZWY1NWI2MmI1ZWE4MjU2NTVfOHVSZnVaUllqekpIT1l4UUlKVlZQNnZheTVrWHo2Z3ZfVG9rZW46Wlk2NmJlNTBGb2Z3ZW94WlUzVGMxdEE0bnpzXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)

![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=NTE0YjBiZjFlMzIxNWVlYTg0OGMyYjkxNjg1MzE2MjhfUEk2R3RZSU05U3o3VENIaG5BbTNvWDJXbXE5VFNjRk9fVG9rZW46WDhsYmJ1RGUzbzlWMDd4UGVDS2NGS09qbnhnXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
...
![](https://feishu.feishu.cn/space/api/box/stream/download/asynccode/?code=OTQ4YjcxY2ZjOGU4NDA0YThkMjQ2NWE2MGU0OGM1ODhfcTlVdzd0VWRBdURjTFpVNHIxYWFkQm5QVzBCaEVnZmxfVG9rZW46RXhyaGI1R1NQb3JrMXJ4NlU1amN0WnJvbkZmXzE3NjUzNjcyMTE6MTc2NTM3MDgxMV9WNA)
